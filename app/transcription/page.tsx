...
export default function TranscriptionPage() {
  ...
  }, [user, authLoading, hydrated, router])

  // Create a new patient session when the component mounts and user is authenticated
  useEffect(() => {
    // Don't create session if not hydrated, user is not authenticated, or still loading
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 relative overflow-hidden">
      {/* Show loading state while checking authentication or hydration */}
      ...
      {/* Show content only when user is authenticated and hydrated */}
